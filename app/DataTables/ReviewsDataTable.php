...
class ReviewsDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('product', function (User $user) {
                return ucwords('Mesh Refletive Piping V-Neck Harness');
            })
            ->editColumn('user', function (User $user) {
                return $user->name;
            })
            ->editColumn('star', function (User $user) {
                return '5';
            })->editColumn('status', function (User $user) {
                return 'Pending';
            })->editColumn('comment', function (User $user) {
                return ucwords('Perfect fit and perfect color for a Tennessee dog. Go Vols!!');
            })
