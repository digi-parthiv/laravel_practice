...
class ProductAttributesDataTable extends DataTable
{
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->rawColumns(['id','name'])
            ->editColumn('slug', function (User $user) {
                return 'Length';
            })
            ->editColumn('order', function (User $user) {
                return '20';
            ...
            ->addColumn('action', function (User $user) {
                return view('pages/apps.e-commerce.product-attributes.columns._actions', compact('user'));
            })
            ->setRowId('id');
    }
